...
slug: animate
title: Animate
summary: Purposeful motion that conveys state, not decoration.
highlights:
  - Interfaces feel lifeless or abrupt between states.
  - Loading, feedback, or transitions need motion that explains what is happening.
  - You want disciplined animation with reduced-motion fallbacks.
related:
  - delight
---
